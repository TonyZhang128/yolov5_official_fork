...
def train(hyp, opt, device, callbacks):
    ...
    scaler = torch.amp.GradScaler('cuda', enabled=amp)# scaler = torch.cuda.amp.GradScaler(enabled=amp)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Forward
            with torch.amp.autocast('cuda', enabled=amp):# with torch.cuda.amp.autocast(amp):
